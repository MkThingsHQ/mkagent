...
printAnnotation('');
printAnnotation('Volatile vs stable: date/time and session_state change per turn;');
printAnnotation('workspace capabilities and working directory are stable for the session.');
...
printSection(
  '3. WORKSPACE CAPABILITIES - formatWorkspaceCapabilities()',
  exampleCapabilities,
  colors.magenta
);
