...
import { getNetworkProxySettings, setNetworkProxySettings } from '@mkagent/shared/config/storage';
import type { NetworkProxySettings } from '@mkagent/shared/config/types';
