...
import { buildLabelTree, getDescendantIds, getLabelDisplayName, flattenLabels, extractLabelId, findLabelById, sortLabelsForDisplay, matchesLabelFilter } from "@mkagent/shared/labels"
import type { LabelConfig, LabelTreeNode } from "@mkagent/shared/labels"
import { resolveEntityColor } from "@mkagent/shared/colors"
            ...
            <div className="flex h-full flex-col select-none">
              ...
              <div className="flex-1 flex flex-col min-h-0">
                ...
                <LeftSidebar
                  ...
                  ].filter(link => MKAGENT_UI_PROFILE.sidebarItems.has(link.id)) as LeftSidebarItem[]}
                />
            ...
            <PanelHeader
              ...
              actions={
                <>
                  ...
                  {MKAGENT_UI_PROFILE.kanban && !isAutoCompact && isSessionsNavigation(navState) && (
                    <BoardListToggle
                      value="list"
                      onChange={view => {
