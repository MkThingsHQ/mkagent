...
import type { StatusConfig } from '@mkagent/shared/statuses'
import { isEmoji } from '@mkagent/shared/utils/icon-constants'
import { resolveEntityColor, getDefaultStatusColor } from '@mkagent/shared/colors'
import type { EntityColor } from '@mkagent/shared/colors'
