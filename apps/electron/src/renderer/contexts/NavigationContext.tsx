...
import { parsePermissionMode } from '@mkagent/shared/agent/mode-types'
...
export { isSessionsNavigation, isSettingsNavigation, isSkillsNavigation, isOpenConnectorNavigation }
